...
public class Aplicacion extends javax.swing.JFrame {
    ...
    public Aplicacion(Listas lista) {
        initComponents();
        this.lista=lista;
    }
     public Aplicacion() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("El porcentaje de reconocimiento es:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        double resultado;
        String resul;
        resultado=corazon.aplicacion(lista.getCapaHide(), lista.getCapaY());
        resultado=resultado*100;
        resul=String.valueOf(resultado);
        resul=resul.substring(0, 2);
        jL_Resultado.setText(resul+"%");
    
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        Entrenar  e=new Entrenar(lista);
        e.setVisible(true);
